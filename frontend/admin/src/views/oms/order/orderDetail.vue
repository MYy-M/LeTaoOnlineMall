<template> 
  <div class="detail-container">
    <div>
      <el-steps
        :active="formatStepStatus(order.orderState)"
    ...
    >
      <div class="operate-container">
        ...
        ></i>
        <span class="color-danger">当前订单状态：{{order.orderState | formatStatus}}</span>
        <div
          class="operate-button-container"
          v-show="order.orderState===0"
        >
          <el-button
            size="mini"
        ...
        <div
          class="operate-button-container"
          v-show="order.orderState===2||order.orderState===3"
        >
          <el-button
            size="mini"
      ...
      <div class="table-layout">
        ...
        <el-row>
          <el-col
            :span="6"
            class="table-cell"
          >{{order.receiverName}}</el-col>
          <el-col
            :span="6"
            class="table-cell"
          >{{order.receiverPhone}}</el-col>
          <el-col
            :span="6"
            class="table-cell"
          >{{order.receiverPostCode}}</el-col>
          <el-col
            :span="6"
            class="table-cell"
          >{{order | formatAddress}}</el-col>
        </el-row>
      </div>
      <div style="margin-top: 20px">
        <svg-icon
      ...
      >
        ...
        >
          <template slot-scope="scope">
            {{scope.row.orderState | formatPayStatus}}
          </template>
        </el-table-column>
        <el-table-column
          label="发货状态"
        ...
        >
          <template slot-scope="scope">
            {{scope.row.orderState | formatDeliverStatus}}
          </template>
        </el-table-column>
        <el-table-column
          label="备注"
