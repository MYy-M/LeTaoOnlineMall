...
) ENGINE=InnoDB AUTO_INCREMENT=1548211767328321539 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC;
...
) ENGINE=InnoDB AUTO_INCREMENT=1546337342148505603 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `commodity_specs` (
  `id` bigint NOT NULL,
  `cid` bigint NOT NULL,
  `cpicture` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
